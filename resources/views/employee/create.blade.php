            ...
            <div class="p-5 bg-light rounded-3 col-xl-6 border">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('age') is-invalid @enderror" name="age" id="age" value="{{ old('age') }}" placeholder="Enter Age">
                        @error('age')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-12 mb-3">
                        ...
                        @error('position')
                            <div class="text-danger">{{ $message }}</small></div>
                        @enderror
                    </div>
                    <div class="col-md-12 mb-3">
