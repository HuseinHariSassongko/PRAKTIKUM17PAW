...
@section('content')
    ...
    <style>
        .modal-content {
            background: linear-gradient(to bottom, #272deb, #f9fafb); /* Gradient dari putih ke biru */
            color: #000; /* Warna teks */
        }
        .modal-header {
            border-bottom: 1px solid rgba(0, 0, 0, 0.1); /* Garis bawah header */
        }
        .modal-footer {
            border-top: 1px solid rgba(0, 0, 0, 0.1); /* Garis atas footer */
        }
    </style>
@endsection
